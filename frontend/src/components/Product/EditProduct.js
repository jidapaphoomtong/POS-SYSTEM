...
//             try {
//                 setIsLoading(true);
//                 const response = await axios.get(`http://localhost:5293/api/Product/products/${productId}`, {
//                     headers: {
...
//             const response = await axios.put(`http://localhost:5293/api/Product/products/${productId}`, formData, {
//                 headers: {
//                     "x-posapp-header": "gi3hcSCTAuof5evF3uM3XF2D7JFN2DS",
//                     Authorization: `Bearer ${token}`,
//                 },
