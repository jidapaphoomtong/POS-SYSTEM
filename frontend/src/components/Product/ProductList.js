...
//             try {
//                 setIsLoading(true);
//                 const response = await axios.get(`http://localhost:5293/api/Product/products`, {
//                     headers: {
...
//         try {
//             const response = await axios.delete(`http://localhost:5293/api/Product/products/${deleteProductId}`, {
//                 headers: {
//                     "x-posapp-header": "gi3hcSCTAuof5evF3uM3XF2D7JFN2DS",
//                     Authorization: `Bearer ${token}`,
//                 },
